...
describe('Logger service', () => {
  ...
  describe('with level OFF', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NgLoggerModule.forRoot(Level.OFF)]
      });
    });
  ...
  describe('with level ERROR', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NgLoggerModule.forRoot(Level.ERROR)]
      });
    });
  ...
  describe('with level WARN', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NgLoggerModule.forRoot(Level.WARN)]
      });
    });

    it('should call groups, warn and error', inject(
      [Logger],
      (logger: Logger) => {
  ...
  describe('with level INFO', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NgLoggerModule.forRoot(Level.INFO)]
      });
    });

    it('should call groups and levels >= INFO', inject(
      [Logger],
      (logger: Logger) => {
  ...
  describe('with level DEBUG', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NgLoggerModule.forRoot(Level.DEBUG)]
      });
    });

    it('should call groups, times and levels >= DEBUG', inject(
      [Logger],
      (logger: Logger) => {
  ...
  describe('with level LOG', () => {
    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NgLoggerModule.forRoot(Level.LOG)]
      });
    });

    it('should call groups, times and all levels', inject(
      [Logger],
      (logger: Logger) => {
